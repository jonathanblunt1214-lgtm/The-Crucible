...
The operator machine, GitHub, and external AI services are execution hosts—not Crucible organs or learning sources. Access is project-bound and default-deny; opted-in repositories are limited to governed operations, while GPU and ChatGPT egress require owner-signed permission plus an offline hard stop. See `governingDocuments/host-isolation-policy.md`.
