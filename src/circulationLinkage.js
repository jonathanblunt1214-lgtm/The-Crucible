...
const SYSTEMS = Object.freeze({
  ...
  digestive: ['safeInformationRetrieval', 'htmlTextExtraction', 'automatedGoogleResearch', 'automatedGoogleResearchCli', 'monthlyKnowledgeRefresh', 'claimExtractionWorker', 'claimExtractionWorkerCli', 'pdfTextExtraction', 'documentFurniture', 'hostedSourceBundle', 'hostedMultiRepositoryIntegration', 'languageCatalog', 'intakePathways'],
