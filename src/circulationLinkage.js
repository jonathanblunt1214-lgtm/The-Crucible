...
const SYSTEMS = Object.freeze({
  brain: ['governingDecision', 'learningGovernance', 'learningOrchestrator', 'globalPolicy', 'globalRepositoryGovernance', 'injectedGovernance', 'injectedGovernanceReconcile', 'handoffPolicy', 'devlogPruneArchive', 'aiConflictLedger', 'aiConflictResolution', 'mutationClaims', 'multiAiDeliberation', 'coordinationGate', 'aiProviderRegistry', 'aiProviderAdapters', 'multiAiOrchestrator', 'devlogAccountability', 'aiHandoffContinuation', 'mutationClaimStore', 'coordinationCli', 'taskRouting', 'taskRoutingCli', 'reasoningProblemSolving', 'creativeDecisionAdaptation', 'criticalClaimReview', 'repositoryOperation', 'requiredCheckBoundary', 'ecosystem', 'config', 'configureSuite', 'suiteSelection', 'folderTopology'],
  nerves: ['testCadence', 'testCadenceCore', 'testCadenceCoreLegacy', 'testCadencePolicy', 'testFeatureClassifier', 'testRunGovernance', 'testingOrgan', 'ciDiagnosticOrgan', 'hostedRunStartupDiagnosis', 'precheck', 'code-check', 'report', 'failureIssue', 'snapshot', 'runner', 'cli', 'maintenance', 'organismHealth'],
  ...
  digestive: ['safeInformationRetrieval', 'htmlTextExtraction', 'automatedGoogleResearch', 'automatedGoogleResearchCli', 'automatedPerplexityResearch', 'automatedPerplexityResearchCli', 'automatedModelPointerResearch', 'automatedModelPointerResearchCli', 'sourceRetrievalWorker', 'sourceRetrievalWorkerCli', 'ownerFileIntake', 'ownerFileIntakeCli', 'monthlyKnowledgeRefresh', 'claimExtractionWorker', 'claimExtractionWorkerCli', 'pdfTextExtraction', 'documentFurniture', 'hostedSourceBundle', 'hostedMultiRepositoryIntegration', 'languageCatalog', 'intakePathways'],
  learning: ['scientificLearning', 'scientificLearningCli', 'learningCycle', 'learningExperience', 'claimComparison', 'claimEvaluationWorker', 'semanticCorroboration', 'pairedCorroboration', 'sourceIndependence', 'realCorpusLearning', 'realCorpusSafety', 'realSupersession', 'knowledgeLifecycle', 'hostedLearningProof', 'preSoakReadiness', 'preSoakReadinessCli', 'soakGate', 'soakRun', 'repairEvidence', 'hypothesisTestPlan', 'languageHypothesisVariables', 'concreteLanguageHarness', 'languageExperimentRegistry', 'contradictionAudit', 'contradictionReopening', 'pipelineTracer', 'scopePreRegistration', 'durableGateEvidence', 'hostedExperimentHarnesses'],
  boundary: ['hostIsolation', 'externalAiFirewall', 'offlineGpuGate', 'durableLock', 'durableLockRecoveryCli'],
  ...
  circulation: ['organismCirculation', 'organismRuntime', 'productionOrganism', 'oversightReflex', 'circulationLinkage', 'gradedOversightResponse', 'findingLedger', 'failureCodes', 'providerCirculation', 'toolchainCirculation'],
});
