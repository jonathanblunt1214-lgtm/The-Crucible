...
const SYSTEMS = Object.freeze({
  ...
  circulation: ['organismCirculation', 'organismRuntime', 'productionOrganism', 'oversightReflex', 'circulationLinkage', 'gradedOversightResponse', 'findingLedger', 'failureCodes', 'providerCirculation'],
});
