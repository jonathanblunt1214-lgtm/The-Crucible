...
const SYSTEMS = Object.freeze({
  ...
  digestive: ['safeInformationRetrieval', 'htmlTextExtraction', 'automatedGoogleResearch', 'automatedGoogleResearchCli', 'automatedPerplexityResearch', 'automatedPerplexityResearchCli', 'sourceRetrievalWorker', 'sourceRetrievalWorkerCli', 'ownerFileIntake', 'ownerFileIntakeCli', 'monthlyKnowledgeRefresh', 'claimExtractionWorker', 'claimExtractionWorkerCli', 'pdfTextExtraction', 'documentFurniture', 'hostedSourceBundle', 'hostedMultiRepositoryIntegration', 'languageCatalog', 'intakePathways'],
